...
// we will follow post order traversal to delete because we first have to delete children then its parent, if we will delete root or parent we will never be able to access children and memory leak will occur.
...
int main(){
  ...
  delete root;// first it will go to destructor method and delete childrens, at last root will be deleted
  //cout << endl;
}
