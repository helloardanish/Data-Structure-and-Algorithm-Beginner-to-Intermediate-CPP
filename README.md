...
|-----|---------------- | --------------- | ------------- |
| 1  | [Max Consecutive Ones](https://leetcode.com/problems/max-consecutive-ones/) | [C++](./Arrays/MaxConsecutiveOnes.cpp) |  Easy |
| 2 | [Find Numbers with Even Number of Digits](https://leetcode.com/problems/find-numbers-with-even-number-of-digits/) | [C++](./Arrays/FindNumberswithEvenNumberofDigits.cpp) |Easy |
| 3 | [Squares of a Sorted Array](https://leetcode.com/problems/squares-of-a-sorted-array/) | [C++](./Arrays/SquaresofaSortedArray.cpp) |Easy |
| 4| [Duplicate Zeros](https://leetcode.com/problems/duplicate-zeros/) | [C++](./Arrays/DuplicateZeros.cpp) |Easy |
| 5 | [Merge Sorted Array](https://leetcode.com/problems/merge-sorted-array/) | [C++](./Arrays/MergeSortedArray.cpp) |Easy |
| 6 | [Remove Element](https://leetcode.com/problems/remove-element/) | [C++](./Arrays/RemoveElement.cpp) |Easy |
| 7 | [Remove Duplicates from Sorted Array](https://leetcode.com/problems/remove-duplicates-from-sorted-array/) | [C++](./Arrays/RemoveDuplicatesfromSortedArray.cpp) |Easy |
| 8 | [Check If N and Its Double Exist](https://leetcode.com/problems/check-if-n-and-its-double-exist/) | [C++](./Arrays/CheckIfNandItsDoubleExist.cpp) |Easy |
